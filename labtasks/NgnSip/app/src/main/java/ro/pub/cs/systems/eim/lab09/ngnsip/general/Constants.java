...
public interface Constants {
    ...
    final public static String IDENTITY_IMPI = "upbsml";
    final public static String IDENTITY_PASSWORD = "ZTTTHzZAbegu9Hbe";
    final public static String DOMAIN = "upbsml.onsip.com";
    final public static String NETWORK_PCSCF_HOST = "sip.onsip.com";
    final public static int NETWORK_PCSCF_PORT = 5060;
    final public static String NETWORK_REALM = "upbsml.onsip.com";
